...
- [ ] Explain what a token is used for.
    - A token is used for providing some security by issuing cryptic text to the server. It can be stored on the client side using local storage.

- [ ] What steps can you take in your web apps to keep your data secure?
    - Step 1: Encrypt the Login pages
    - Step 2: Keep a clean code
    - Step 3: Back up the data
    - Step 4: Go back over the code for vulnerabilities.

- [ ] Describe how web servers work.
    Web servers are either a computer that stores the code for a website or a program that runs on such a computer
